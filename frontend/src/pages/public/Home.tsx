            ...
            <Stack align="center" gap="lg">
              ...
              >
                <Text ta="center" c="white" maw={600} className={classes.heroText}>
                  SpeakMate vous met en relation avec des tuteurs expérimentés
                  pour améliorer votre anglais et progresser rapidement.
                </Text>
              </motion.div>
              ...
              {[
                {
                  name: "Alice",
                  feedback:
                    "J'ai utilisé SpeakMate et ça m'a beaucoup aidée à progresser en anglais !",
                },
                {
                  name: "Mohamed",
                  feedback:
                    "Grâce à SpeakMate, j'ai trouvé un tuteur parfait pour mes besoins.",
                },
                {
                  name: "Fatou",
                  feedback:
                    "Plateforme intuitive et tuteurs très compétents !",
                },
              ].map((testi, index) => (
                <motion.div
                  key={index}
